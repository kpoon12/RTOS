...
xTaskHandle  GUI_Task_Handle = NULL;
xTaskHandle  DEBUG_Task_Handle = NULL;
...
static void ETHERNET_CreatePage(uint8_t Page)
{
  ...
  switch (Page)
  {
    ...
    case ETHERNET_WEBSERVER_PAGE:
    {
      ...
      GL_SetPageHeader(EthernetWebServerPage , (uint8_t *)"MODEL F");
