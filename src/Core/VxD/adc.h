...
#define FB_SPARE_IN1  		((ANALOG_INPUT_ADC << 4)	 | CHANNEL_3) // (0x01 << 4) | 0x00 = 0x12
#define FB_SPARE_IN2  		((ANALOG_INPUT_ADC << 4)	 | CHANNEL_2) // (0x01 << 4) | 0x00 = 0x13
...
#define	FB_SETPOT			((CURRENT_SERVO_ADC << 4)	 | CHANNEL_3) // (0x02 << 4) | 0x02 = 0x22
#define	FB_PS_VOLTAGE		((CURRENT_SERVO_ADC << 4)    | CHANNEL_2) // (0x03 << 4) | 0x00 = 0x23
